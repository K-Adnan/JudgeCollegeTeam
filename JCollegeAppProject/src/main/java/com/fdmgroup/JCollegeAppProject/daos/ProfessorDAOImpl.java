...
public class ProfessorDAOImpl implements ProfessorDAO {
	...
	public void removeProfessor(int professorId) {
		EntityManager manager = factory.createEntityManager();
		Professor professor = manager.find(Professor.class, professorId);
		manager.getTransaction().begin();
	...
	public Professor getProfessorByCourse(Course course) {
		EntityManager manager = factory.createEntityManager();
		TypedQuery<Professor> query = manager.createQuery("FROM Professor p WHERE p.course =?", Professor.class);
	...
	public List<Professor> getAllProfessorsByDepartment(Department department) {
		EntityManager manager = factory.createEntityManager();
		TypedQuery<Professor> query = manager.createQuery("FROM professor p WHERE p.department =?", Professor.class);
